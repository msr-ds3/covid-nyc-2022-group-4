...
First we have to insert our libraries and zip codes files to make sure we have NYC zip codes
...
First we grab the proportion of 18-64 year old population that is uninsured. We'll make a table, a linear model and summarize all of that data.
